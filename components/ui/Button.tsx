...
const variants: Record<Variant, string> = {
  primary: "bg-accent text-accent-foreground hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
  secondary:
    "bg-transparent text-foreground border border-surface-border hover:border-accent/50 hover:bg-surface",
};
